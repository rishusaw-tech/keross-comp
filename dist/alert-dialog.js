...
function AlertDialogTitle(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(AlertDialogPrimitive.Title, Object.assign({ "data-slot": "alert-dialog-title", className: cn("text-lg font-semibold bg-background", className) }, props)));
}
function AlertDialogDescription(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(AlertDialogPrimitive.Description, Object.assign({ "data-slot": "alert-dialog-description", className: cn("text-muted-foreground text-sm bg-background", className) }, props)));
}
...
function AlertDialogCancel(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(AlertDialogPrimitive.Cancel, Object.assign({ className: cn(buttonVariants({ variant: "outline" }), "bg-background", className) }, props)));
}
